...
// =========================================
// FOR DEMO SITE ONLY! (Dark & Light style)
// =========================================
...
$(".style-switcher").on("click",function() {
   $("body").toggleClass("dark-style");
   $("body").hasClass("dark-style") ? (localStorage.setItem("darkstyle", "true"), 
   $(".style-switcher").addClass("is-dark")) : (localStorage.setItem("darkstyle", "false"), 
   $(".style-switcher").removeClass("is-dark"));
});

// localStorage (not work in IE on localhost!)
var d = localStorage.getItem("darkstyle");
d == "true" ? ($("body").addClass("dark-style"),
   $(".style-switcher").addClass("is-dark")) : ($("body").removeClass("dark-style"),
   $(".style-switcher").removeClass("is-dark"));
