...
namespace InstaAlbum.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName,CreatedDate,UpdatedDate")] tblCategory tblCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,CategoryName,CreatedDate,UpdatedDate")] tblCategory tblCategory)
        {
            if (ModelState.IsValid)
            {
